        ...
        emoji.emojize(
            ":gear:") + f' Это только первая версия (V.1.0), в дальнейшем проект будет улучшаться, и функционал будет расширяться.\n'
                        f'Наша команда: ' + emoji.emojize(":busts_in_silhouette:") + '\n'
                                                                                     f'· <u>Андрей Тощаков</u> - создатель всего и вся этого проекта\n'
...
async def cmd_help(message: types.Message):
    await message.answer("Основные команды:"
                         ...
                         f"\n\n <b>2)</b> /logic - Задачи на логику. Тоже самое что и задачи по математике, только другие"
                         f" категории заданий" + emoji.emojize(":book:") +

                         f"\n\n <b>3)</b> /flashcard - Пользовательские карточки. Флеш-карточки - это удобный способ "
                         ...
                         f"\n\n <b>4)</b> /timer - Таймер. Вы можете поставить время выполнения определйнных заданий. "
                         ...
                         f"Прописать /timer --> нажать на 'Создать таймер' --> Ввести нужное время --> Всё, готово, таймер создан! " + emoji.emojize(
        ":clock1:") +

                         f"\n\n <b>5)</b> /cancel - Отмена текущего действия. Если бот не работает, то после ввода "
                         f"этой функции, программа починиться" + emoji.emojize(":stop_sign:"),
